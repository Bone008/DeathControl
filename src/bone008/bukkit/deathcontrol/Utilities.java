...
public final class Utilities {
	 ...
	 * 
	 * @param <T>
	 *            The type which the list is expected to be. <u>Note: Must be explicitly declared in the method call!</u>
	 * @param sec
	 *            The ConfigurationSection to use
	 * @param node
	 *            The node to use
	 * @return
	 */
	 ...
	 * 
	 * @param delimiter
	 *            The delimiter to separate the elements.
	 * @param collection
	 *            The Collection to take the elements from.
	 ...
	 * @param search
	 *            The condition to replace {@code obj}
	 * @param repl
	 *            The value to replace {@code obj} with if {@code search} matched
	 */
