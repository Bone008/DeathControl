...
public class InfoCommand extends SubCommand {
	...
	//
	//			return StringUtil.copyPartialMatches(userList, DeathControl.instance.itemLists.getListNames(), matches);
	//		}
	//
	...
	public void execute(CommandContext context) throws CommandException {
		...
		//				context.sender.sendMessage(GRAY + "Registered lists (" + YELLOW + DeathControl.instance.itemLists.getListsAmount() + GRAY + "):");
		//				Iterator<String> it = DeathControl.instance.itemLists.getListNames().iterator();
		//				while (it.hasNext()) {
		...
		//
		//				List<ListItem> list = DeathControl.instance.itemLists.getList(listName);
		//				if (list == null) {
		//					// it's prettier not to throw a CommandException here
		...
		//		context.sender.sendMessage(pre + RESET + "registered valid lists: " + YELLOW + DeathControl.instance.itemLists.getListsAmount());
		//
